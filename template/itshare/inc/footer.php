...
<!-- jquery Core-->
<script src="/template/itshare/assest/js/jquery-2.1.4.min.js"></script>

<!-- Bootstrap -->
<script src="/template/itshare/assest/js/bootstrap.min.js"></script>

<!-- Theme Menu -->
<script src="/template/itshare/assest/js/mobile-menu.js"></script>

<!-- Owl carousel -->
<script src="/template/itshare/assest/js/owl.carousel.min.js"></script>

<!-- Theme Script -->
<script src="/template/itshare/assest/js/script.js"></script>
</body>
</html>
<?php  
	$mysqli->close();
